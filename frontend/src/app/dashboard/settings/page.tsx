        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="p-6 rounded-2xl glass-card space-y-4">
            ...
            <div className="space-y-3 text-xs leading-relaxed text-foreground">
              ...
              <ol className="list-decimal list-inside space-y-2 border-l border-border pl-2 mt-2">
                <li>
                ...
                <li>
                  ...
                  <pre className="mt-1.5 p-2.5 rounded bg-muted border border-border font-mono text-[10px] text-muted-foreground overflow-x-auto">
          ...
          <div className="p-6 rounded-2xl glass-card space-y-4">
            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="flex justify-between items-center py-1.5">
                ...
                <span className="text-foreground font-mono">AES-256-CBC</span>
              </div>
            </div>
          </div>
